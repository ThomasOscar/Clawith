...
function AgentDetailInner() {
    ...
    const ChatMessageItem = React.useMemo(() => React.memo(({
        ...
        const resolvedSenderLabel = senderLabel ?? msg.sender_name;
                                                ...
                                                return historyMsgs.map((m: any, i: number) => {
                                                    ...
                                                    return (
                                                        <ChatMessageItem
                                                            ...
                                                            isLeft={isLeft}
                                                            t={t}
                                                            senderLabel={isHumanReadonly ? (isLeft ? ((agent as any)?.name || 'Agent') : (activeSession.username || 'User')) : (isA2A && m.sender_name && m.sender_name !== thisAgentName ? m.sender_name : undefined)}
                                                            avatarText={isHumanReadonly ? (isLeft ? (((agent as any)?.name || 'Agent')[0]) : ((activeSession.username || 'User')[0])) : (isLeft ? (m.sender_name ? m.sender_name[0] : 'A') : 'U')}
                                                            forceSenderLabel={isHumanReadonly || (isA2A && !!m.sender_name && m.sender_name !== thisAgentName)}
                                                        />
                                                    );
                                                });
                                            })()}
